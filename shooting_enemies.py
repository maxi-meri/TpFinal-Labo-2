...
class EnemigoDisparo(Personaje):
    ...
    def __init__(self, x, y, animations, energia, tipo):
        ...
        # Distancia a la que el hongo deja de acercarse y empieza a disparar.
        # Antes usaba RANGO_ENEMIGOS, entonces la condicion distancia > rango_disparo
        # nunca se cumplia dentro del rango de vision y el hongo quedaba quieto.
        self.rango_disparo = consts.DISTANCIA_DISPARO_HONGOS
        self.cooldown_disparo = consts.COOLDOWN_DISPARO_ENEMIGOS
