...
class Personaje():
    def __init__(self, x, y, animations, energia, tipo):
        ...
        # Aportes de Nico: experiencia, niveles, daño variable, velocidad y escudo
        self.exp = 0
        self.exp_max = 10
        self.nivel = 1
        self.daño = 50
    ...
    def movimiento(self, delta_x, delta_y, obstaculos_tiles, exit_tile):
        ...
        #Camara
        if self.tipo == 1:
            # Salida: si exit_tile es None, la puerta/salida queda bloqueada
            # (lo usamos para que no pueda pasar de ronda hasta matar enemigos).
